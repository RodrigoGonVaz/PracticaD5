...
const Anime             =require("./../models/Anime") // los .. permite salirte de la carpeta donde estas


require("dotenv").config()   // Lo vamos a ocupar para la variable de entorno de MONGO DB
